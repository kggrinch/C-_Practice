...
//
//   /** Gets the height of this binary tree. @return The height of the binary tree. */
//   virtual int getHeight() const = 0;
//
//   /** Gets the number of nodes in this binary tree. @return The number of nodes in the binary tree. */
//   virtual int getNumberOfNodes() const = 0;
//
//   /** Gets the data that is in the root of this binary tree.
//   @pre The binary tree is not empty.
//   @post The root’s data has been returned, and the binary tree is unchanged. @return The data in the root of the binary tree. */
...
//
//   /** Removes the node containing the given data item from this binary tree. @param data The data value to remove from the binary tree.
...
//   is unchanged. If no such entry was found, an exception is thrown. @param anEntry The entry to locate.
//   @return The entry in the binary tree that matches the given entry. @throw NotFoundException if the given entry is not in the tree. */
